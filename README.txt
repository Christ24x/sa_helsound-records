...
Rôles :
  ...
  * Développement du module main.py
...
Dans le cadre de ce projet, nous avons ajouté plusieurs fonctionnalités supplémentaires :

1.  Visualisation des données

   * Création de graphiques (streams par  genre)
